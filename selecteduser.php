...
?>
	...
	<div class="container">
        <h2 class="text-center pt-4">Transaction Profile</h2>
            <?php
                include 'connect.php';
                $sid=$_GET['id'];
        ...
        <br>
            ...
            <a href="transactiondetails.php"><button class="btn mt-3" name="submit" type="submit" id="myBtn">Transfer</button></a>
            </div>
        </form>
    </div>
